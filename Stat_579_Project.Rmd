...
#-----------------------------------------------------------------------------------------------------------------------------------#
df %>% filter(City_Department_Involved == "STREETS & SANITATION") %>% {print(unique(.$Primary_Cause))}

df %>% filter(City_Department_Involved == "POLICE" & str_detect(Primary_Cause, "CIVIL")) %>% {print(unique(.$Primary_Cause))}
