...
df %>% filter(is.na(Date_to_Comptroller) == TRUE) # Date_to_Comptroller is the joined Year, Month, including day, there each have 2 missing values making a total of 6.  This should be re-separated. (3)
